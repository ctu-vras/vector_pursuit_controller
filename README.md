...
| `max_linear_decel`                 | Maximum allowed deceleration. Should be negative. 0 = no limit.  |
...
|| `approach_deceleration_gain`       | Set higher than 1.0 if the robot reacts too slowly to deceleration limits (goes too fast). |
...
controller_server:
  ros__parameters:
    ...
    FollowPath:
      ...
      approach_deceleration_gain: 1.0
